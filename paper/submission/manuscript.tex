...
used to (i) write and refactor software: the benchmarking code in
\texttt{paper/experiments/} (interfaces to the competing methods, the
...
of the local search; (ii) propose analyses and methodological extensions,
including the benchmark design and the factor block model, which the authors
evaluated before adopting; (iii) run the analyses and produce tables and figures
from the scripts' outputs; (iv) draft and revise manuscript text; and (v) check
citations and reported values against primary records and the analysis outputs.
The authors reviewed the resulting code, analyses and text and take full
responsibility for the content. Every value reported here is written by a script
in the public repository, so each AI-assisted analysis can be re-run and checked
independently.
...
We thank the Simulation in Python class at the University of Kansas, where this project of evolving solutions with evolutionary algorithms began. Claude Opus 5 (Anthropic) was also used for language editing; its full role in this work, including software development and analysis, is described under ``Use of generative AI tools'' in Materials and methods. The authors take full responsibility for the content of the manuscript.
