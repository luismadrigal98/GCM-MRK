...
\title{Genetic Clustering by Metric: metric-guided clustering by genetic algorithm for correlation-defined modules}
...
% Flush the remaining Results figures so the Discussion starts on a clean page.
\clearpage
\section*{Discussion}
...
All source code for the \tool{} package, along with the reproduction scripts to generate the results and figures presented in this manuscript, is publicly available under an open-source license on GitHub at \url{https://github.com/luismadrigal98/GCM-MRK}. The version of the code accompanying this manuscript is archived on Zenodo (DOI: 10.5281/zenodo.22848121); DOI 10.5281/zenodo.21361264 covers all archived versions and resolves to the most recent one. The breast-cancer RNA-seq dataset (GSE183947) analyzed in this study is publicly available from the NCBI Gene Expression Omnibus (GEO). The expression compendia and curated module definitions of the Saelens et al.\ benchmark are available from Zenodo (DOI: 10.5281/zenodo.5532578); the scripts in \texttt{paper/experiments/} document how they were subset and scored.
