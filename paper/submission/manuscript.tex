...
used to (i) assist with the documentation of code and refactor software for organization: 
the benchmarking code in \texttt{paper/experiments/} (interfaces to the competing methods, the
data-generating processes, and the analysis and figure scripts) and parts of the
\tool{} package, including the factor block-model objectives and the speed-up
of the local search; (ii) audit analyses and methodological decisions,
