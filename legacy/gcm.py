...
def parse_args():
    ...
    parser.add_argument('--num_reference_points', type=int, required=False, help='The number of reference points used for searching the Pareto front')
